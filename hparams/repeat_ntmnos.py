...
def train_opts(parser):
    ...
    group.add_argument('-fload', type=str, default='repeat-overall-ntmnos-1548256268.model')
    group.add_argument('-bsz', type=int, default=2)
    group.add_argument('-lr', type=float, default=1e-3)
    group.add_argument('-min_len_train', type=int, default=4)
    ...
    group.add_argument('-pattern', type=str, default='110')
