...
class EncoderNTMnos(MARNNBaseEncoder):

    def __init__(self, idim, cdim, N, M, drop, read_first):
        super(EncoderNTMnos, self).__init__(idim, cdim, N, M, drop, read_first=read_first)
