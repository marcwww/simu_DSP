...
from .MARNNr import MARNNrBaseEncoder
import time
...
class EncoderNTMr(MARNNrBaseEncoder):

    def __init__(self, idim, cdim, N, M, drop, read_first):
        super(EncoderNTMr, self).__init__(idim, cdim, N, M, drop, read_first=read_first)
